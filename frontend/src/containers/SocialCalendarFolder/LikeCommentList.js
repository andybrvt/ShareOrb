...
class LikeCommentList extends React.Component{
  constructor(props){
    super(props);
    // this.initialisePost()
  ...
  render () {
    ...
    if (this.props.data.commentUser.profile_picture){
      console.log(this.props.data.commentUser.profile_picture)
      profilePic = `${global.IMAGE_ENDPOINT}`+this.props.data.commentUser.profile_picture
    }
    return (
      ...
      <List
        ...
        dataSource = {this.props.data.comment_people_like}
        renderItem = {item => (
        <List.Item
