...
class CalPrefSettings extends React.Component{
...
CalPrefSettings = reduxForm({
  form: "calendar preference settings",  // give the form a name
...
export default CalPrefSettings;
