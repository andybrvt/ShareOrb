...
export const UNSHOW_INITIAL_INSTRUCTIONS = "UNSHOW_INITIAL_INSTRUCTIONS";
...
// This will be added to the auth instead of the notification
export const ADD_ONE_NOTIFICIATION_SEEN = "ADD_ONE_NOTIFICIATION_SEEN";
...
export const UPDATE_GOING_NOT_LIST = "UPDATE_GOING_NOT_LIST";
...
export const SEND_SOCIAL_CAL_CELL_COMMENT_LIKE_UNLIKE='SEND_SOCIAL_CAL_CELL_COMMENT_LIKE_UNLIKE';
...
export const SEND_SOCIAL_EVENT_INVITE = "SEND_SOCIAL_EVENT_INVITE";
