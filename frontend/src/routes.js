...
import AndyCalendar from './containers/andyCalendar';
  ...
  render() {
    ...
    console.log(this.props);
      ...
      <div>
        ...
        <Route exact path = '/andycalendar/' render={(props) => <AndyCalendar {...props} {...this.props} isAuthenticated={this.props.isAuthenticated} />}  />
