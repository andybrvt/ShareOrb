...
ALLOWED_HOSTS = ['172.31.26.195', 'api.shareorb.com','shareorb-env.eba-zm7j48gb.us-west-1.elasticbeanstalk.com']
...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            "hosts": [('shareorbredis.bz41az.ng.0001.usw1.cache.amazonaws.com', 6379)],
        },
    },
}
STATICFILES_DIRS = [
