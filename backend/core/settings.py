...
ALLOWED_HOSTS = ['172.31.4.121', 'api.shareorb.com','shareorb-env.eba-zm7j48gb.us-west-1.elasticbeanstalk.com']
...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            "hosts": ["redis://shareorbredisnew.bz41az.ng.0001.usw1.cache.amazonaws.com:6379"],
        },
    },
}
STATICFILES_DIRS = [
